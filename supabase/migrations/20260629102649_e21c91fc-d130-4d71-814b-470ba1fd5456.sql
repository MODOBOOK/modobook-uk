...
ALTER TABLE public.profiles
  ...
  ADD COLUMN IF NOT EXISTS booking_max_lead_days integer NOT NULL DEFAULT 90,
  ...
  ADD COLUMN IF NOT EXISTS booking_daily_cap integer,
  ADD COLUMN IF NOT EXISTS booking_smart_times_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS payment_pass_fees_to_customer boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS payment_klarna_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS payment_clearpay_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS payment_card_full_enabled boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS payment_deposit_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS require_deposit_to_confirm boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS allow_pay_in_clinic boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS show_prices_on_booking boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS enforce_cancellation_fee boolean NOT NULL DEFAULT false,
  ...
  ADD COLUMN IF NOT EXISTS require_dob boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS require_address boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS require_medical_forms_before_appt boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS allow_patient_reschedule boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS allow_patient_cancel boolean NOT NULL DEFAULT true,
  ...
  ADD COLUMN IF NOT EXISTS reminder_hours_before integer[] NOT NULL DEFAULT ARRAY[24,2];
