...
ALTER TABLE public.treatments
  ...
  ADD COLUMN IF NOT EXISTS allow_split_payment boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS rebook_reminder_days integer;

ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS chooser_consultation_treatment_ids uuid[] NOT NULL DEFAULT '{}'::uuid[],
  ADD COLUMN IF NOT EXISTS chooser_extra_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS chooser_extra_title text,
  ADD COLUMN IF NOT EXISTS chooser_extra_body text,
  ADD COLUMN IF NOT EXISTS chooser_extra_treatment_ids uuid[] NOT NULL DEFAULT '{}'::uuid[];
