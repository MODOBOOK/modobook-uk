...
RETURNS TABLE(
  ...
  chooser_enabled boolean, chooser_show_know boolean, chooser_show_unsure boolean,
  chooser_show_consultation boolean, chooser_consultation_treatment_id uuid,
  chooser_consultation_treatment_ids uuid[], chooser_intro_text text,
  chooser_extra_enabled boolean, chooser_extra_title text, chooser_extra_body text,
  chooser_extra_treatment_ids uuid[],
  model_slots_position text,
