do $$
declare r record; mid text; html text; txt text; logo text := 'https://yfbkbtsxufvxkbpoyjjn.supabase.co/storage/v1/object/sign/clinic-assets/b8118d60-745e-4130-8008-085bab10df35/logo/1782773849006.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9kODU4NTc5Yy00MmVjLTQ2NjUtYjI4YS0wZGI3YmI5MmIwMDYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJjbGluaWMtYXNzZXRzL2I4MTE4ZDYwLTc0NWUtNDEzMC04MDA4LTA4NWJhYjEwZGYzNS9sb2dvLzE3ODI3NzM4NDkwMDYucG5nIiwic2NvcGUiOiJkb3dubG9hZCIsImlhdCI6MTc4Mjc3Mzg0OSwiZXhwIjoyMDk4MTMzODQ5fQ.p0y8a2nvrk_iaHHK7hHpHIZ42uIjPAL1AKCBTjrRclA';
begin
for r in
  select * from (values
...
loop
  ...
  perform public.enqueue_email('transactional_emails', jsonb_build_object(
    ...
    'idempotency_key', mid, 'queued_at', now()));
end loop;
end $$;