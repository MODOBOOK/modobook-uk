  ...
  .handler(async ({ data, context }) => {
    ...
    const samples: Record<string, Record<string, unknown>> = {
      'booking-confirmation': {
        ...
        location: profile.clinic_name || 'Your studio',
        date: 'Fri 12 Jul 2026',
        time: '14:30',
        duration: '60 minutes',
        treatmentPrice: '£150.00',
        amountPaid: '£30.00',
        amountDue: '£120.00',
        paymentNote: 'A £30.00 deposit has been taken. £120.00 remains to pay.',
        manageUrl: profile.slug ? `https://modobook.uk/m/${profile.slug}` : 'https://modobook.uk',
        calendarGoogleUrl: 'https://calendar.google.com/calendar/render?action=TEMPLATE',
        calendarAppleUrl: 'https://modobook.uk/api/public/calendar?title=Lip+filler+consultation&date=2026-07-12&start=14%3A30&end=15%3A30&location=Your+studio',
      },
