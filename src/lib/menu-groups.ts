...
export const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Branding", description: "Colours, fonts, logo & favicon", to: "/dashboard/branding", icon: PaletteIcon, ...T.sand },
      { label: "Workspace appearance", description: "Colours & fonts for your own dashboard only", to: "/dashboard/appearance", icon: PaletteIcon, ...T.ivory },
      ...
      { label: "Locations", description: "Manage your clinic addresses", to: "/dashboard/locations", icon: MapPinIcon, ...T.cream },
